 ...
 */
public enum PaymentWalletTypeEnum {
  ...
  PaymentWalletTypeEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentWalletTypeEnum fromValue(String value) {
    for (PaymentWalletTypeEnum b : PaymentWalletTypeEnum.values()) {
