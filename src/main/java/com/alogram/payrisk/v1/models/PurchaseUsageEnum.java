...
public enum PurchaseUsageEnum {
  ...
  PurchaseUsageEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PurchaseUsageEnum fromValue(String value) {
    for (PurchaseUsageEnum b : PurchaseUsageEnum.values()) {
