 ...
 */
public enum PaymentRealtimeTypeEnum {
  ...
  PaymentRealtimeTypeEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentRealtimeTypeEnum fromValue(String value) {
    for (PaymentRealtimeTypeEnum b : PaymentRealtimeTypeEnum.values()) {
