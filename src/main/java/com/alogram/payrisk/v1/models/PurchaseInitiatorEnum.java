 ...
 */
public enum PurchaseInitiatorEnum {
  ...
  PurchaseInitiatorEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PurchaseInitiatorEnum fromValue(String value) {
    for (PurchaseInitiatorEnum b : PurchaseInitiatorEnum.values()) {
